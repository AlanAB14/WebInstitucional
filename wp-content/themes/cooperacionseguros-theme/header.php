...
<head>
  ...
  <script>
    var environment = '<?php echo get_environment(); ?>';
  </script>

  <?php wp_head(); ?>

  <!-- Global site tag (gtag.js) - Google Analytics -->
  <script async src="https://www.googletagmanager.com/gtag/js?id=<?php echo get_environment() == 'prod' ? 'UA-154793366-1' : 'UA-154793366-2'; ?>"></script>
  <script>
    ...
    gtag('config', '<?php echo get_environment() == 'prod' ? 'UA-154793366-1' : 'UA-154793366-2'; ?>');
  </script>
  ...
  <script>
    ...
    })(window, document, 'script', 'dataLayer', '<?php echo get_environment() == 'prod' ? 'GTM-PXJ8MMZ' : 'GTM-K5MCW3Z' ?>');
  </script>
...
<body <?php body_class(); ?>>
  ...
  <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=<?php echo get_environment() == 'prod' ? 'GTM-PXJ8MMZ' : 'GTM-K5MCW3Z' ?>" height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
