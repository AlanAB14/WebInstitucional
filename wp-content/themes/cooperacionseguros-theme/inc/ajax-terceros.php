...
if (!isset($_POST['consulta'])) {
  ...
  } else if ($consulta == 'guardar') {
    if (isset($_POST['paso']) && (isset($_POST['data'])) && (isset($_POST['data']['guid']))) {
      $data = $_POST['data'];
      $file_path = get_template_directory() . '/' . COOPSEG_RECLAMOS_DIR . '/' . $data['guid'] . '.json';
      $data['paso'] = $_POST['paso'];
