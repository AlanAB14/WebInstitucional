              ...
              <?php foreach ($benefits as $benefit) : ?>
                <div class="opciones beneficios wrap">
                  <?php if ($benefit == "Servicio de auxilio mecánico") : ?>
                    ...
                    <div><?php echo $plansData[$recommended['basic']]['benefits'][$benefit]; ?>km <small>(<?php echo $plansData[$recommended['basic']]['benefits'][$benefit] * 2; ?>)</small></div>

                    <?php if (isset($recommended['medium'])) : ?>
                      <div><?php echo $plansData[$recommended['medium']]['benefits'][$benefit]; ?>km <small>(<?php echo $plansData[$recommended['medium']]['benefits'][$benefit] * 2; ?>)</small></div>
                    <?php endif; ?>

                    <?php if (isset($recommended['full'])) : ?>
                      <div><?php echo $plansData[$recommended['full']]['benefits'][$benefit]; ?>km <small>(<?php echo $plansData[$recommended['full']]['benefits'][$benefit] * 2; ?>)</small></div>
                    <?php endif; ?>
                  <?php else : ?>
                    <?php if ($benefit == 'Reposición a nuevo de la unidad') : ?>
                      <div class="detail">
                    ...
                    <?php if (isset($recommended['full'])) : ?>
                      <?php if (isset($plansData[$recommended['full']]['benefit'][$benefit])) : ?>
                        <div><span class="on">Incluida</span></div>
                      <?php else : ?>
                        <div><span class="off">No incluida</span></div>
                      <?php endif; ?>
