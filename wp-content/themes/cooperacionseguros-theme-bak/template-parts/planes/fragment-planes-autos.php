...
<?php else :
  ...
  <?php else :
    ...
    <section id="cobertura" class="seleccion-de-planes vehiculos transaccional <?php echo isset($recommended['full']) ?? 'double'; ?>">
        ...
        <div class="desktop"> <!-- START DESKTOP -->
          <div class="opciones header wrap">
            ...
            <div class="plan medium">
              <?php if(empty($plans->{$recommended['full']})) echo '<h3>Recomendado</h3>'; ?>
              <h1>Superior</h1>
